...
from DQN_sigmoid import load_table
from DQN_sigmoid import save_table
##from DQN_sigmoid import calculate_reward
...
##        dqn = DQN_sigmoid(5,15,3)
        if save_weights.upper() == 'Y':
            ...
            dqn = DQN_sigmoid(5,15,3,w1_pre,w2_pre)
